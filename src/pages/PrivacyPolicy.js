      ...
      <div className="container">
        <div className="policy-content">
          ...
          <section>
            ...
            <ul>
              <li><strong>MAYtastic</strong></li>
              <li><strong>Phone:</strong> 7738267309</li>
              <li><strong>Email:</strong> themayankperspective1828@gmail.com</li>
              <li><strong>Time:</strong> Mon to Fri (9AM to 6PM)</li>
            </ul>
          </section>
